...
<section class="content">
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Edit Transfusi</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
    ...
    <section class="content">
                    <div class="container-fluid">
                        ...
                        <div class="card">
                            <!-- /.card-header -->
                            <form action="{{ route('AdmTransfusi.update', [$Transfusi->id]) }}" method="POST">
                            @CSRF
                            @method('put')
                                <div class="card-body">
                                    <div class="column">
                                    <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group mb-3">
                                                    <select class="form-control" name="id_penerima" id="id_penerima">
                                                        ...
                                                        <option value="{{$Transfusi->id_penerima}}" >{{$Transfusi->Penerima->nama_penerima}}</option>
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label>Tanggal</label>
                                                <input type="text" name="tanggal" id="tanggal" class="form-control" value="{{$Transfusi->tanggal}}"/>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                            <div class="form-group">
                                                <label for="jumlah">Jumlah</label>
                                                <input type="text" name="jumlah" id="jumlah" class="form-control" placeholder="Jumlah" value="{{$Transfusi->jumlah}}"/>
                                            </div>
                                        </div>
                                    </div>
                                </div>
