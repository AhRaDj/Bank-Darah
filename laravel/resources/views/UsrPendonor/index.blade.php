...
<head>
  ...
  <title>Blood Bank | Pendonor</title>
  ...
  <div class="register-box">
    ...
    <div class="card">
      <div class="card-body register-card-body">
        <p class="login-box-msg">Daftar sebagai Pendonor</p>

        <form action="{{ route('UsrPendonor.store') }}" method="POST">
          @CSRF
          <div class="input-group mb-3">
            <input type="text" id="nama_pendonor" name="nama_pendonor" class="form-control @error('nama_pendonor') is-invalid @enderror" placeholder="Nama Lengkap">
            <small class="text-danger">@error('nama_pendonor') {{$message}} @enderror</small>
